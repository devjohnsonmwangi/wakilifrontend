                ...
                <div className="relative bg-white shadow-xl rounded-xl p-6 w-full md:w-2/3 lg:w-1/2 max-h-[80vh] overflow-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        {[
                            ...
                            { label: "Full Name", value: selectedCase.user.full_name, icon: FaUser },
                            { label: "Email", value: selectedCase.user.email, icon: FaEnvelope },
                            { label: "Phone", value: selectedCase.user.phone_number, icon: FaPhone },
